...
namespace Showmatics.Host.Controllers.Multitenancy;
...
public class TenantsController : VersionNeutralApiController
{
    ...
    [OpenApiOperation("Update tenant.", "")]
    public async Task<ActionResult<string>> UpdateAsync(UpdateTenantRequest request, string id)
    {
