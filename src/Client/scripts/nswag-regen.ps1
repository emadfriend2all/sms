...
$infrastructurePrj = $rootDirectory + '/src/Client/src/Client.Infrastructure/Client.Infrastructure.csproj'
...
Write-Host "Infrastructure Directory is $infrastructurePrj `n"
<# Run command #>
