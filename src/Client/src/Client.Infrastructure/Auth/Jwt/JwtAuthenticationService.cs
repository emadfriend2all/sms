...
namespace Showmatics.Blazor.Client.Infrastructure.Auth.Jwt;
...
public class JwtAuthenticationService : AuthenticationStateProvider, IAuthenticationService, IAccessTokenProvider
{
    ...
    private readonly IClientPreferenceManager _preferenceManager;
    ...
    public JwtAuthenticationService(ILocalStorageService localStorage, IPersonalClient personalClient, ITokensClient tokensClient, NavigationManager navigation, IClientPreferenceManager preferenceManager)
    {
    ...
    public async Task<bool> LoginAsync(string tenantId, TokenRequest request)
    {
        ...
        var tenantInfo = authState.User.GetCurrentUserTenantInfo();

        await _preferenceManager.SetTenantColorsAsync(tenantInfo);
        return true;
    }
    ...
    private async Task ClearCacheAsync()
    {
        ...
        //await _localStorage.RemoveItemAsync(StorageConstants.Local.TenantInfo);
    }
