...
/// <typeparam name="TAddRequest">The type of the Request which is used on the AddEditModal and which is sent with the CreateFunc and UpdateFunc.</typeparam>
public abstract class EntityTableContext<TEntity, TId, TAddRequest>
{
    /// <summary>
    ...
    /// </summary>
    public Func<TId, Task<TAddRequest>>? GetDetailsFunc { get; }
    ...
    /// No need to check for error messages or api exceptions. These are automatically handled by the component.
    /// </summary>
    public Func<TId, TAddRequest, Task>? UpdateFunc { get; }
    ...
    public EntityTableContext(
        ...
        Func<TId, Task<TAddRequest>>? getDetailsFunc,
        Func<TId, TAddRequest, Task>? updateFunc,
    ...
    public IAddEditModal<TAddRequest> AddEditModal =>
        _addEditModalRef?.Dialog as IAddEditModal<TAddRequest>
    ...
    public EntityServerTableContext<TEntity, TId, TAddRequest>? ServerContext => this as EntityServerTableContext<TEntity, TId, TAddRequest>;
