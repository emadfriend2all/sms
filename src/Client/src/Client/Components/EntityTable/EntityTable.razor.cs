    ...
    where TRequest : new()
{
    ...
    [Parameter]
    public RenderFragment? ExtraTools { get; set; }
    [Parameter]
    ...
    public IEnumerable<TEntity>? _entityList;
    ...
    private async Task InvokeModal(TEntity? entity = default)
    {
        ...
        var dialog = DialogService.Show<AddEditModal<TRequest>>(string.Empty, parameters);
