...
namespace Showmatics.Blazor.Client.Pages.Identity.Roles;
...
public partial class RolePermissions
{
    ...
    public TenantBasicInfoDto? tenantInfo;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        tenantInfo = state.User.GetCurrentUserTenantInfo();
            ...
            is RoleDto role && role.Permissions is not null)
        {
            ...
            _groupedRoleClaims = permissions.Where(x => tenantInfo != null && tenantInfo.Modules!.Contains(x.Resource))
