...
public class ConfigureJwtBearerOptions : IConfigureNamedOptions<JwtBearerOptions>
{
    ...
    private readonly IOptions<ApiJwtSettings> _apiJwtSettings;

    public ConfigureJwtBearerOptions(
        IOptions<JwtSettings> jwtSettings,
        IOptions<ApiJwtSettings> partnerJwtSettings)
    {
        _jwtSettings = jwtSettings;
        _apiJwtSettings = partnerJwtSettings;
    }
    ...
    {
        var settings = name == "ApiToken" ? _apiJwtSettings.Value : _jwtSettings.Value;
