...
namespace Showmatics.Infrastructure.Auth.AzureAd;
...
internal class AzureAdJwtBearerEvents : JwtBearerEvents
{
    ...
    public override async Task TokenValidated(TokenValidatedContext context)
    {
        ...
        // We use the givenName claim to store the userName.
        var userNameClaim = principal.FindFirst(ClaimTypes.GivenName);
        identity.TryRemoveClaim(userNameClaim);
        identity.AddClaim(new Claim(ClaimTypes.GivenName, userNameClaim.Value));
